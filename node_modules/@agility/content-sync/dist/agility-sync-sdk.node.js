...
var legacy = __webpack_require__(19)
...
if (!fs[gracefulQueue]) {
  ...
  if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
    process.on('exit', function() {
      ...
      __webpack_require__(1).equal(fs[gracefulQueue].length, 0)
    })
  }
}
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var fs = __webpack_require__(2);
var os = __webpack_require__(6);
var path = __webpack_require__(3);var _require =
__webpack_require__(0),sleep = _require.sleep;var _require2 =
__webpack_require__(15),lockSync = _require2.lockSync,unlockSync = _require2.unlockSync,checkSync = _require2.checkSync,check = _require2.check;
...
var getFilePath = function getFilePath(_ref) {var options = _ref.options,itemType = _ref.itemType,languageCode = _ref.languageCode,itemID = _ref.itemID;
  var fileName = "".concat(itemID, ".json");

  return path.join(options.rootPath, languageCode, itemType, fileName);
};

var saveItem = /*#__PURE__*/function () {var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref2) {var options, item, itemType, languageCode, itemID, filePath, dirPath, json;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:options = _ref2.options, item = _ref2.item, itemType = _ref2.itemType, languageCode = _ref2.languageCode, itemID = _ref2.itemID;
            ...
            fs.writeFileSync(filePath, json);case 6:case "end":return _context.stop();}}}, _callee);}));return function saveItem(_x) {return _ref3.apply(this, arguments);};}();


var deleteItem = /*#__PURE__*/function () {var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref4) {var options, itemType, languageCode, itemID, filePath;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:options = _ref4.options, itemType = _ref4.itemType, languageCode = _ref4.languageCode, itemID = _ref4.itemID;

            filePath = getFilePath({ options: options, itemType: itemType, languageCode: languageCode, itemID: itemID });

            if (fs.existsSync(filePath)) {
              fs.unlinkSync(filePath);
            }case 3:case "end":return _context2.stop();}}}, _callee2);}));return function deleteItem(_x2) {return _ref5.apply(this, arguments);};}();



var mergeItemToList = /*#__PURE__*/function () {var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref6) {var options, item, languageCode, itemID, referenceName, definitionName, contentList, cIndex;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:options = _ref6.options, item = _ref6.item, languageCode = _ref6.languageCode, itemID = _ref6.itemID, referenceName = _ref6.referenceName, definitionName = _ref6.definitionName;_context3.next = 3;return (
            ...
            if (contentList == null) {
              ...
              saveItem({ options: options, item: contentList, itemType: "list", languageCode: languageCode, itemID: referenceName }));case 7:case "end":return _context3.stop();}}}, _callee3);}));return function mergeItemToList(_x3) {return _ref7.apply(this, arguments);};}();


var getItem = /*#__PURE__*/function () {var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(_ref8) {var options, itemType, languageCode, itemID, filePath, json;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:options = _ref8.options, itemType = _ref8.itemType, languageCode = _ref8.languageCode, itemID = _ref8.itemID;
            ...
            JSON.parse(json));case 6:case "end":return _context4.stop();}}}, _callee4);}));return function getItem(_x4) {return _ref9.apply(this, arguments);};}();
...
var waitOnLock = /*#__PURE__*/function () {var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(lockFile) {return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:_context6.next = 2;return (

              check(lockFile));case 2:if (!_context6.sent) {_context6.next = 7;break;}_context6.next = 5;return (
              sleep(100));case 5:_context6.next = 0;break;case 7:case "end":return _context6.stop();}}}, _callee6);}));return function waitOnLock(_x6) {return _ref12.apply(this, arguments);};}();




var mutexLock = /*#__PURE__*/function () {var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {var dir, lockFile;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
            ...
            _context7.next = 5;return waitOnLock(lockFile);case 5:_context7.prev = 5;return _context7.abrupt("return",


            lockSync(lockFile));case 9:_context7.prev = 9;_context7.t0 = _context7["catch"](5);if (!(

            "".concat(_context7.t0).indexOf("Lock file is already being held") !== -1)) {_context7.next = 28;break;}_context7.next = 14;return (


              sleep(100));case 14:_context7.next = 16;return (
              waitOnLock(lockFile));case 16:_context7.prev = 16;return _context7.abrupt("return",


            lockSync(lockFile));case 20:_context7.prev = 20;_context7.t1 = _context7["catch"](16);if (!(

            "".concat(_context7.t0).indexOf("Lock file is already being held") !== -1)) {_context7.next = 28;break;}_context7.next = 25;return (


              sleep(100));case 25:_context7.next = 27;return (
              waitOnLock(lockFile));case 27:return _context7.abrupt("return",
            lockSync(lockFile));case 28:throw (




              Error("The mutex lock could not be obtained."));case 29:case "end":return _context7.stop();}}}, _callee7, null, [[5, 9], [16, 20]]);}));return function mutexLock() {return _ref13.apply(this, arguments);};}();
...
const lockfile = __webpack_require__(16);
const { toPromise, toSync, toSyncOptions } = __webpack_require__(28);
...
const retry = __webpack_require__(21);
const onExit = __webpack_require__(24);
const mtimePrecision = __webpack_require__(27);
...
var RetryOperation = __webpack_require__(23);
...
var signals = __webpack_require__(25)
...
var agility_content_fetch_node = __webpack_require__(8);
 ...
 */
/* harmony default export */ var syncContent = (function (_x, _x2) {return syncContent_ref.apply(this, arguments);});function syncContent_ref() {syncContent_ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(languageCode, token) {var storeInterface, itemCount, busy, waitMS, waitMaxMS, waitIntervalMS, syncRet, syncItems, index;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            storeInterface = this.store;
            ...
            Object(util["logWarning"])("Sync API has been busy for too long, canceling.");return _context.abrupt("break", 33);case 15:
            ...
            if (!busy) {
              ...
              Object(util["sleep"])(waitIntervalMS));case 18:return _context.abrupt("continue", 32);case 19:
            ...
            if (!(syncItems.length === 0)) {_context.next = 23;break;}return _context.abrupt("break", 33);case 23:
            ...
            token > 0 || busy === true) {_context.next = 7;break;}case 33:
            ...
            token);case 35:case "end":return _context.stop();}}}, _callee, this);}));return syncContent_ref.apply(this, arguments);}
...
/* harmony default export */ var clearSync = (function () {return clearSync_ref.apply(this, arguments);});function clearSync_ref() {clearSync_ref = clearSync_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {var storeInterface;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            storeInterface = this.store;_context.next = 3;return (
              storeInterface.clear());case 3:
            Object(util["logSuccess"])("Cleared Sync Items");case 4:case "end":return _context.stop();}}}, _callee, this);}));return clearSync_ref.apply(this, arguments);}
// CONCATENATED MODULE: ./src/methods/syncPages.js
function syncPages_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function syncPages_asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {syncPages_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {syncPages_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}

/* harmony default export */ var syncPages = (function (_x, _x2) {return syncPages_ref.apply(this, arguments);});function syncPages_ref() {syncPages_ref = syncPages_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(languageCode, token) {var storeInterface, itemCount, busy, waitMS, waitMaxMS, waitIntervalMS, syncRet, syncItems, index;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            storeInterface = this.store;
            if (!token) token = 0;
            ...
            waitIntervalMS = 500;case 7:_context.next = 9;return (
              ...
              this.agilityClient.getSyncPages({
                syncToken: token,
                pageSize: 100,
                languageCode: languageCode }));case 9:syncRet = _context.sent;if (!(
            ...
            token);case 35:case "end":return _context.stop();}}}, _callee, this);}));return syncPages_ref.apply(this, arguments);}
...
var syncRunner = /*#__PURE__*/function () {var _ref = runSync_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {var storeInterface, lockRelease;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:

            storeInterface = this.store.getStore();

            //if a mutex has been defined, call the wait lock
            lockRelease = null;if (!(
            storeInterface.mutexLock !== undefined)) {_context.next = 6;break;}_context.next = 5;return (
              storeInterface.mutexLock());case 5:lockRelease = _context.sent;case 6:_context.prev = 6;_context.next = 9;return (
              ...
              sync(this));case 9:_context.prev = 9;


            if (lockRelease) {
              lockRelease();
            }return _context.finish(9);case 12:case "end":return _context.stop();}}}, _callee, this, [[6,, 9, 12]]);}));return function syncRunner() {return _ref.apply(this, arguments);};}();





var sync = /*#__PURE__*/function () {var _ref2 = runSync_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(clientObj) {var languageCodes, channels, storeInterface, modeStr, _iterator, _step, languageCode, syncState, lastSyncDate, newItemToken, newPageToken, _iterator2, _step2, channelName, sitemap, sitemapNested, urlRedirections, lastAccessDate;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:

            languageCodes = clientObj.config.languages;
            channels = clientObj.config.channels;
            storeInterface = clientObj.store;

            modeStr = clientObj.config.isPreview ? "preview" : "live";_iterator = _createForOfIteratorHelper(

            languageCodes);_context2.prev = 5;_iterator.s();case 7:if ((_step = _iterator.n()).done) {_context2.next = 68;break;}languageCode = _step.value;_context2.next = 11;return (


              storeInterface.getSyncState(languageCode));case 11:syncState = _context2.sent;

            if (!syncState) syncState = { itemToken: 0, pageToken: 0 };

            lastSyncDate = syncState.lastSyncDate || null;
            //run at MOST once a second
            if (!(lastSyncDate && new Date() - new Date(lastSyncDate) < 1000)) {_context2.next = 16;break;}return _context2.abrupt("continue", 66);case 16:




            Object(util["logSuccess"])("Starting Sync for ".concat(languageCode, " - ").concat(modeStr, " mode."));_context2.next = 19;return (
              clientObj.syncContent(languageCode, syncState.itemToken));case 19:newItemToken = _context2.sent;_context2.next = 22;return (
              clientObj.syncPages(languageCode, syncState.pageToken));case 22:newPageToken = _context2.sent;if (!(

            newItemToken != syncState.itemToken ||
            newPageToken != syncState.pageToken)) {_context2.next = 48;break;}
            //if we sync ANYTHING - pull the new sitemap down
            _iterator2 = _createForOfIteratorHelper(
            channels);_context2.prev = 25;_iterator2.s();case 27:if ((_step2 = _iterator2.n()).done) {_context2.next = 40;break;}channelName = _step2.value;
            Object(util["logInfo"])("Updating Sitemap channel ".concat(channelName, " in ").concat(languageCode));_context2.next = 32;return (

              clientObj.agilityClient.getSitemapFlat({ channelName: channelName, languageCode: languageCode }));case 32:sitemap = _context2.sent;
            storeInterface.saveSitemap({ sitemap: sitemap, languageCode: languageCode, channelName: channelName });_context2.next = 36;return (

              clientObj.agilityClient.getSitemapNested({ channelName: channelName, languageCode: languageCode }));case 36:sitemapNested = _context2.sent;
            storeInterface.saveSitemapNested({ sitemapNested: sitemapNested, languageCode: languageCode, channelName: channelName });case 38:_context2.next = 27;break;case 40:_context2.next = 45;break;case 42:_context2.prev = 42;_context2.t0 = _context2["catch"](25);_iterator2.e(_context2.t0);case 45:_context2.prev = 45;_iterator2.f();return _context2.finish(45);case 48:_context2.next = 50;return (





              storeInterface.getUrlRedirections({ languageCode: languageCode }));case 50:urlRedirections = _context2.sent;
            lastAccessDate = null;
            if (urlRedirections) lastAccessDate = urlRedirections.lastAccessDate;_context2.next = 55;return (

              clientObj.agilityClient.getUrlRedirections({ lastAccessDate: lastAccessDate }));case 55:urlRedirections = _context2.sent;if (!(
            urlRedirections && urlRedirections.isUpToDate === false)) {_context2.next = 60;break;}
            Object(util["logInfo"])("URL Redirections Updated and Saved");_context2.next = 60;return (
              storeInterface.saveUrlRedirections({ urlRedirections: urlRedirections, languageCode: languageCode }));case 60:


            syncState.itemToken = newItemToken;
            syncState.pageToken = newPageToken;
            syncState.lastSyncDate = new Date();_context2.next = 65;return (

              storeInterface.saveSyncState({ syncState: syncState, languageCode: languageCode }));case 65:

            Object(util["logSuccess"])("Completed Sync for ".concat(languageCode, " - ").concat(modeStr, " mode."));case 66:_context2.next = 7;break;case 68:_context2.next = 73;break;case 70:_context2.prev = 70;_context2.t1 = _context2["catch"](5);_iterator.e(_context2.t1);case 73:_context2.prev = 73;_iterator.f();return _context2.finish(73);case 76:case "end":return _context2.stop();}}}, _callee2, null, [[5, 70, 73, 76], [25, 42, 45, 48]]);}));return function sync(_x) {return _ref2.apply(this, arguments);};}();




/* harmony default export */ var runSync = (syncRunner);
// CONCATENATED MODULE: ./src/store-interface.js
function store_interface_createForOfIteratorHelper(o, allowArrayLike) {var it;if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) {if (Array.isArray(o) || (it = store_interface_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") {if (it) o = it;var i = 0;var F = function F() {};return { s: F, n: function n() {if (i >= o.length) return { done: true };return { done: false, value: o[i++] };}, e: function e(_e) {throw _e;}, f: F };}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion = true,didErr = false,err;return { s: function s() {it = o[Symbol.iterator]();}, n: function n() {var step = it.next();normalCompletion = step.done;return step;}, e: function e(_e2) {didErr = true;err = _e2;}, f: function f() {try {if (!normalCompletion && it["return"] != null) it["return"]();} finally {if (didErr) throw err;}} };}function store_interface_unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return store_interface_arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return store_interface_arrayLikeToArray(o, minLen);}function store_interface_arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function store_interface_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function store_interface_asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {store_interface_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {store_interface_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}

var store_interface_store = null;
var options = null;

var validateStoreInterface = function validateStoreInterface(storeCandidate) {
...
var setStore = function setStore(storeToUse, storeOptions) {
  validateStoreInterface(storeToUse);
  store_interface_store = storeToUse;
  options = storeOptions;
};

var getStore = function getStore() {
  return store_interface_store;
};
...
var saveContentItem = /*#__PURE__*/function () {var _ref2 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {var contentItem, languageCode, definitionName, referenceName, currentItem;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:contentItem = _ref.contentItem, languageCode = _ref.languageCode;if (!(


            !contentItem ||
            !contentItem.properties)) {_context.next = 4;break;}

            Object(util["logWarning"])("Null item or item with no properties cannot be saved");return _context.abrupt("return");case 4:
            ...
            Object(util["logWarning"])("Content with id ".concat(contentItem.contentID, " does not have the neccessary properties to be saved."));return _context.abrupt("return");case 20:_context.next = 22;return (
              ...
              store_interface_store.saveItem({
                options: options,
                item: contentItem,
                itemType: "item",
                languageCode: languageCode,
...
var savePageItem = /*#__PURE__*/function () {var _ref4 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref3) {var pageItem, languageCode;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:pageItem = _ref3.pageItem, languageCode = _ref3.languageCode;if (!(
            pageItem.properties.state === 3)) {_context2.next = 6;break;}_context2.next = 4;return (

              store_interface_store.deleteItem({
                options: options,
                itemType: "page",
                languageCode: languageCode,
                itemID: pageItem.pageID }));case 4:_context2.next = 8;break;case 6:_context2.next = 8;return (
              ...
              store_interface_store.saveItem({
                ...
                itemType: "page",
                languageCode: languageCode,
                itemID: pageItem.pageID }));case 8:case "end":return _context2.stop();}}}, _callee2);}));return function savePageItem(_x2) {return _ref4.apply(this, arguments);};}();




var saveSitemap = /*#__PURE__*/function () {var _ref6 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref5) {var sitemap, channelName, languageCode;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:sitemap = _ref5.sitemap, channelName = _ref5.channelName, languageCode = _ref5.languageCode;_context3.next = 3;return (
              store_interface_store.saveItem({
                options: options,
                item: sitemap,
                itemType: "sitemap",
                languageCode: languageCode,
                itemID: channelName }));case 3:case "end":return _context3.stop();}}}, _callee3);}));return function saveSitemap(_x3) {return _ref6.apply(this, arguments);};}();



var saveSitemapNested = /*#__PURE__*/function () {var _ref8 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(_ref7) {var sitemapNested, channelName, languageCode;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
            sitemapNested = _ref7.sitemapNested,
            channelName = _ref7.channelName,
            languageCode = _ref7.languageCode;_context4.next = 3;return (
              ...
              store_interface_store.saveItem({
                ...
                languageCode: languageCode,
                itemID: channelName }));case 3:case "end":return _context4.stop();}}}, _callee4);}));return function saveSitemapNested(_x4) {return _ref8.apply(this, arguments);};}();



var saveUrlRedirections = /*#__PURE__*/function () {var _ref10 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(_ref9) {var urlRedirections, languageCode;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:urlRedirections = _ref9.urlRedirections, languageCode = _ref9.languageCode;_context5.next = 3;return (
              store_interface_store.saveItem({
                options: options,
                item: urlRedirections,
                itemType: "urlredirections",
                languageCode: languageCode,
                itemID: "urlredirections" }));case 3:case "end":return _context5.stop();}}}, _callee5);}));return function saveUrlRedirections(_x5) {return _ref10.apply(this, arguments);};}();



var getUrlRedirections = /*#__PURE__*/function () {var _ref12 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(_ref11) {var languageCode;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:languageCode = _ref11.languageCode;_context6.next = 3;return (
              store_interface_store.getItem({
                options: options,
                itemType: "urlredirections",
                languageCode: languageCode,
                itemID: "urlredirections" }));case 3:return _context6.abrupt("return", _context6.sent);case 4:case "end":return _context6.stop();}}}, _callee6);}));return function getUrlRedirections(_x6) {return _ref12.apply(this, arguments);};}();



var saveSyncState = /*#__PURE__*/function () {var _ref14 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(_ref13) {var syncState, languageCode;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:syncState = _ref13.syncState, languageCode = _ref13.languageCode;_context7.next = 3;return (
              store_interface_store.saveItem({
                options: options,
                item: syncState,
                itemType: "state",
                languageCode: languageCode,
                itemID: "sync" }));case 3:case "end":return _context7.stop();}}}, _callee7);}));return function saveSyncState(_x7) {return _ref14.apply(this, arguments);};}();



var getSyncState = /*#__PURE__*/function () {var _ref15 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(languageCode) {return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:_context8.next = 2;return (
              store_interface_store.getItem({
                options: options,
                itemType: "state",
                languageCode: languageCode,
                itemID: "sync" }));case 2:return _context8.abrupt("return", _context8.sent);case 3:case "end":return _context8.stop();}}}, _callee8);}));return function getSyncState(_x8) {return _ref15.apply(this, arguments);};}();



var getContentItem = /*#__PURE__*/function () {var _ref17 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(_ref16) {var contentID, languageCode, _ref16$depth, depth, contentItem;return regeneratorRuntime.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:contentID = _ref16.contentID, languageCode = _ref16.languageCode, _ref16$depth = _ref16.depth, depth = _ref16$depth === void 0 ? 2 : _ref16$depth;_context9.next = 3;return (
              store_interface_store.getItem({
                options: options,
                itemType: "item",
                languageCode: languageCode,
                itemID: contentID }));case 3:contentItem = _context9.sent;_context9.next = 6;return (

              expandContentItem({ contentItem: contentItem, languageCode: languageCode, depth: depth }));case 6:return _context9.abrupt("return", _context9.sent);case 7:case "end":return _context9.stop();}}}, _callee9);}));return function getContentItem(_x9) {return _ref17.apply(this, arguments);};}();


var expandContentItem = /*#__PURE__*/function () {var _ref19 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(_ref18) {var contentItem, languageCode, depth, fields, fieldName, fieldValue, childItem, sortIDAry, childItems, _iterator, _step, childItemID, _childItem;return regeneratorRuntime.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:contentItem = _ref18.contentItem, languageCode = _ref18.languageCode, depth = _ref18.depth;if (
            contentItem) {_context10.next = 3;break;}return _context10.abrupt("return", null);case 3:if (!(

            depth > 0)) {_context10.next = 46;break;}
            //make this work for the .fields or the .customFields property...
            fields = contentItem.fields;
            if (!fields) fields = contentItem.customFields;_context10.t0 = regeneratorRuntime.keys(
            fields);case 7:if ((_context10.t1 = _context10.t0()).done) {_context10.next = 46;break;}fieldName = _context10.t1.value;
            fieldValue = fields[fieldName];if (
            fieldValue) {_context10.next = 14;break;}return _context10.abrupt("continue", 7);case 14:if (!(


            fieldValue.contentid > 0)) {_context10.next = 21;break;}_context10.next = 17;return (

              getContentItem({
                contentID: fieldValue.contentid,
                languageCode: languageCode,
                depth: depth - 1 }));case 17:childItem = _context10.sent;

            if (childItem != null) fields[fieldName] = childItem;_context10.next = 44;break;case 21:if (!(
            fieldValue.sortids && fieldValue.sortids.split)) {_context10.next = 44;break;}
            //multi linked item
            sortIDAry = fieldValue.sortids.split(",");
            childItems = [];_iterator = store_interface_createForOfIteratorHelper(
            sortIDAry);_context10.prev = 25;_iterator.s();case 27:if ((_step = _iterator.n()).done) {_context10.next = 35;break;}childItemID = _step.value;_context10.next = 31;return (
              getContentItem({
                contentID: childItemID,
                languageCode: languageCode,
                depth: depth - 1 }));case 31:_childItem = _context10.sent;

            if (_childItem != null) childItems.push(_childItem);case 33:_context10.next = 27;break;case 35:_context10.next = 40;break;case 37:_context10.prev = 37;_context10.t2 = _context10["catch"](25);_iterator.e(_context10.t2);case 40:_context10.prev = 40;_iterator.f();return _context10.finish(40);case 43:

            fields[fieldName] = childItems;case 44:_context10.next = 7;break;case 46:return _context10.abrupt("return",



            contentItem);case 47:case "end":return _context10.stop();}}}, _callee10, null, [[25, 37, 40, 43]]);}));return function expandContentItem(_x10) {return _ref19.apply(this, arguments);};}();
...
var getContentList = /*#__PURE__*/function () {var _ref21 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(_ref20) {var referenceName, languageCode;return regeneratorRuntime.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:referenceName = _ref20.referenceName, languageCode = _ref20.languageCode;_context11.next = 3;return (
              store_interface_store.getItem({
                ...
                itemType: "list",
                languageCode: languageCode,
                itemID: referenceName }));case 3:return _context11.abrupt("return", _context11.sent);case 4:case "end":return _context11.stop();}}}, _callee11);}));return function getContentList(_x11) {return _ref21.apply(this, arguments);};}();
 ...
 * @returns
 */
var getPage = /*#__PURE__*/function () {var _ref23 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(_ref22) {var pageID, languageCode, _ref22$depth, depth, pageItem, zoneName, zone, _iterator2, _step2, mod, moduleItem;return regeneratorRuntime.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:pageID = _ref22.pageID, languageCode = _ref22.languageCode, _ref22$depth = _ref22.depth, depth = _ref22$depth === void 0 ? 3 : _ref22$depth;_context12.next = 3;return (
              store_interface_store.getItem({
                options: options,
                itemType: "page",
                languageCode: languageCode,
                itemID: pageID }));case 3:pageItem = _context12.sent;if (!(


            depth > 0)) {_context12.next = 30;break;}_context12.t0 = regeneratorRuntime.keys(

            pageItem.zones);case 6:if ((_context12.t1 = _context12.t0()).done) {_context12.next = 30;break;}zoneName = _context12.t1.value;
            zone = pageItem.zones[zoneName];_iterator2 = store_interface_createForOfIteratorHelper(

            zone);_context12.prev = 10;_iterator2.s();case 12:if ((_step2 = _iterator2.n()).done) {_context12.next = 20;break;}mod = _step2.value;_context12.next = 16;return (
              getContentItem({
                options: options,
                contentID: mod.item.contentid,
                languageCode: languageCode,
                depth: depth - 1 }));case 16:moduleItem = _context12.sent;

            mod.item = moduleItem;case 18:_context12.next = 12;break;case 20:_context12.next = 25;break;case 22:_context12.prev = 22;_context12.t2 = _context12["catch"](10);_iterator2.e(_context12.t2);case 25:_context12.prev = 25;_iterator2.f();return _context12.finish(25);case 28:_context12.next = 6;break;case 30:return _context12.abrupt("return",




            pageItem);case 31:case "end":return _context12.stop();}}}, _callee12, null, [[10, 22, 25, 28]]);}));return function getPage(_x12) {return _ref23.apply(this, arguments);};}();


var getSitemap = /*#__PURE__*/function () {var _ref25 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(_ref24) {var channelName, languageCode;return regeneratorRuntime.wrap(function _callee13$(_context13) {while (1) {switch (_context13.prev = _context13.next) {case 0:channelName = _ref24.channelName, languageCode = _ref24.languageCode;_context13.next = 3;return (
              store_interface_store.getItem({
                options: options,
                itemType: "sitemap",
                languageCode: languageCode,
                itemID: channelName }));case 3:return _context13.abrupt("return", _context13.sent);case 4:case "end":return _context13.stop();}}}, _callee13);}));return function getSitemap(_x13) {return _ref25.apply(this, arguments);};}();



var getSitemapNested = /*#__PURE__*/function () {var _ref27 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(_ref26) {var channelName, languageCode;return regeneratorRuntime.wrap(function _callee14$(_context14) {while (1) {switch (_context14.prev = _context14.next) {case 0:channelName = _ref26.channelName, languageCode = _ref26.languageCode;_context14.next = 3;return (
              store_interface_store.getItem({
                options: options,
                itemType: "nestedsitemap",
                languageCode: languageCode,
                itemID: channelName }));case 3:return _context14.abrupt("return", _context14.sent);case 4:case "end":return _context14.stop();}}}, _callee14);}));return function getSitemapNested(_x14) {return _ref27.apply(this, arguments);};}();
 ...
 */
var clear = /*#__PURE__*/function () {var _ref28 = store_interface_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15() {return regeneratorRuntime.wrap(function _callee15$(_context15) {while (1) {switch (_context15.prev = _context15.next) {case 0:_context15.next = 2;return (
              store_interface_store.clearItems({ options: options }));case 2:case "end":return _context15.stop();}}}, _callee15);}));return function clear() {return _ref28.apply(this, arguments);};}();


/* harmony default export */ var store_interface = ({
  ...
  saveUrlRedirections: saveUrlRedirections,
  getUrlRedirections: getUrlRedirections,
  getSyncState: getSyncState,
  saveSyncState: saveSyncState,
  clear: clear,
  setStore: setStore,
  getStore: getStore });
// EXTERNAL MODULE: ./src/store-interface-filesystem.js
var store_interface_filesystem = __webpack_require__(9);
var store_interface_filesystem_default = /*#__PURE__*/__webpack_require__.n(store_interface_filesystem);
...
function createSyncCient(userConfig) {
  ...
  var store = config.store["interface"];

  //set the sync storage interface provider, it will also validate it
  store_interface.setStore(store, config.store.options);
